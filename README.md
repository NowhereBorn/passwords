...
[**Pritam**](https://github.com/NowhereBorn)
...
```bash
git clone https://github.com/NowhereBorn/passwords.git
cd passwords
open index.html
```
...
👉 [https://github.com/NowhereBorn/passwords/blob/main/LICENSE](https://github.com/NowhereBorn/passwords/blob/main/LICENSE)
